...
SELECT Name, Color, Name + Color FROM Production.Product WHERE Color is NOT NULL
...
--Note: In SQL, ^ is only used inside square brackets [] as part of a character class to negate a set of characters in some database systems (like SQL Server). 
--But outside of [], it has no special meaning in SQL patterns.
